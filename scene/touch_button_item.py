...
class TouchButtonItem(QGraphicsObject):
    ...
    def paint(self, painter: QPainter, option, widget=None):
        ...
        if is_band:
            ...
            text_color = QColor(COLOR_CENTER_BAND)
        ...
        if self._charge_progress > 0.01:
            ...
            painter.drawRoundedRect(charge_rect, 6, 6)
        ...
        if is_band:
            ...
            if key_val:
                ...
                painter.setFont(QFont(font_name, 16, QFont.Weight.Bold))
            else:
    ...
    def hoverEnterEvent(self, event):
        if self._mode == 'edit':
            ...
            if self.data.btn_type == BTN_TYPE_CENTER_BAND:
                ...
                QTimer.singleShot(100, lambda: self.set_visual_state('normal'))
