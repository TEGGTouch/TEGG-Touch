...
class FloatingApp:
    def __init__(self, root):
        ...
        self.middle_was_down = False  # [新增] 中键状态
        self.holding_btn_left = None
        self.holding_btn_right = None
        self.holding_btn_middle = None # [新增] 中键按住的按钮
    ...
    def edit_btn(self, idx):
        ...
        top.geometry("360x650") # [修改] 增加高度适配新选项
            ...
            if self.current_mode == 'run':
                ...
                for idx, btn in enumerate(self.buttons_config):
                    ...
                    if in_x and in_y:
                        ...
                        if middle_is_down: target_state = 'active_middle' # [新增] 视觉状态
                ...
                self.middle_was_down = middle_is_down # [新增] 更新历史
        except: pass
        self.root.after(1, self.update_loop)
